...
import { SolrCollectionSchemaAddCopyFieldParams }    from './generated';
import { SolrCollectionSchemaDeleteCopyFieldParams } from './generated';
...
export class SolrCollectionSchemaCopyFields {
     ...
     */
    async list() {
        const { copyFields } = await this.schema.request<SolrCollectionSchemaGetRequest, object, SolrSchemaCopyFieldsResponse>({
            method: 'get',
            endpoint: '/copyfields',
        });
     ...
     * @public
     */
    async add(copyFields: MaybeCollection<SolrCollectionSchemaAddCopyFieldParams>) {
     ...
     * @public
     */
    async delete(copyFields: MaybeCollection<SolrCollectionSchemaDeleteCopyFieldParams>) {
        return this.schema.request<SolrCollectionSchemaPostRequest>({
            method: 'post',
            data: {
